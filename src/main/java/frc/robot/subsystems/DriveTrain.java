...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    ...
    double rampRate = DriveConstants.drivingRamp;
    motorDriveLeft1.setClosedLoopRampRate(rampRate);
    motorDriveLeft1.setOpenLoopRampRate(rampRate);
    motorDriveLeft2.setClosedLoopRampRate(rampRate);
    motorDriveLeft2.setOpenLoopRampRate(rampRate);
    motorDriveLeft3.setClosedLoopRampRate(rampRate);
    motorDriveLeft3.setOpenLoopRampRate(rampRate);
    motorDriveRight1.setClosedLoopRampRate(rampRate);
    motorDriveRight1.setOpenLoopRampRate(rampRate);
    motorDriveRight2.setClosedLoopRampRate(rampRate);
    motorDriveRight2.setOpenLoopRampRate(rampRate);
    motorDriveRight3.setClosedLoopRampRate(rampRate);
    motorDriveRight3.setOpenLoopRampRate(rampRate);
  ...
  public static double getL1Volt() {
    return motorDriveLeft1.getMotorTemperature();
  }
  
  public static double getL2Volt() {
    return motorDriveLeft2.getMotorTemperature();
  }
  
  public static double getL3Volt() {
    return motorDriveLeft3.getMotorTemperature();
  }
  
  public static double getR1Volt() {
    return motorDriveRight1.getMotorTemperature();
  }
  
  public static double getR2Volt() {
    return motorDriveRight2.getMotorTemperature();
  }
  
  public static double getR3Volt() {
    return motorDriveRight3.getMotorTemperature();
  }
}