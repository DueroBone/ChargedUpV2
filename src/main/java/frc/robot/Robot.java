...
// import frc.robot.Controllers.dynamicXbox;
...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Lifter Speed", Arm.info.getLifterSpeed());
    SmartDashboard.putNumber("Extender Speed", Arm.info.getExtenderSpeed());
    SmartDashboard.putNumber("Extender Position", Arm.info.getExtenderPosition());
    SmartDashboard.putNumber("Lifter Position", Arm.info.getLifterPosition());
  ...
  public void teleopPeriodic() {
    ...
    counter1++;
    if (counter1 % 3 == 0) {
      double trigger = RobotContainer.DriveControllerChooser.getSelected().object.getRightTriggerAxis();
